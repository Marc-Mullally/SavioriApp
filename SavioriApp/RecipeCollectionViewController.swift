...
class RecipeCollectionViewController: UICollectionViewController {
    ...
    let recipes = [
        RecipeList(name: "Japan", recipelist:
                            [Recipe(recipeName: "Fried Rice"), Recipe(recipeName: "Shrimp Fried Rice")], imageView: #imageLiteral(resourceName: "Japan")),
        RecipeList(name: "Cubian", recipelist: [Recipe(recipeName: "Rice"),Recipe(recipeName: "Cooked")], imageView: #imageLiteral(resourceName: "cuba flag")),
        RecipeList(name: "Greek", recipelist: [Recipe(recipeName: "Recipe")], imageView: #imageLiteral(resourceName: "greek")),
        RecipeList(name: "Greek", recipelist: [Recipe(recipeName: "Recipe")], imageView: #imageLiteral(resourceName: "greek")),
                   ]
